...
public class ParamStatement
{
     ...
     */
    public ParamStatement(Connection connection, String query) throws SQLException {
        indexMap = new HashMap();
        String parsedQuery = parse(query, indexMap);
        statement = connection.prepareStatement(parsedQuery);
    }

    public ParamStatement(Connection connection, String query, int autoGeneratedKeys) throws SQLException {
        indexMap = new HashMap();
        String parsedQuery = parse(query, indexMap);
